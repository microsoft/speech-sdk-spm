...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "MicrosoftCognitiveServicesSpeech-iOS",
            url: "https://csspeechstorage.blob.core.windows.net/drop/0.0.0-test/MicrosoftCognitiveServicesSpeech-XCFramework-0.0.0-test.zip",
            checksum: "d3eb539a556352f3f47881d71fb0e5777b2f3e9a4251d283c18c67ce996774b7"
        ),
        .binaryTarget(
            name: "MicrosoftCognitiveServicesSpeech-macOS",
            url: "https://csspeechstorage.blob.core.windows.net/drop/0.0.0-test/MicrosoftCognitiveServicesSpeech-MacOSXCFramework-0.0.0-test.zip",
            checksum: "d3eb539a556352f3f47881d71fb0e5777b2f3e9a4251d283c18c67ce996774b7"
        ),
        .binaryTarget(
            name: "MicrosoftCognitiveServicesSpeechEmbedded-iOS",
            url: "https://csspeechstorage.blob.core.windows.net/drop/0.0.0-test/MicrosoftCognitiveServicesSpeech-EmbeddedXCFramework-0.0.0-test.zip",
            checksum: "d3eb539a556352f3f47881d71fb0e5777b2f3e9a4251d283c18c67ce996774b7"
        )
    ]
)
